...
#            if domain == 'freq':           
#                stack_t_cf = np.zeros([1,maxShift])
#            else:
#                stack_t_cf = np.zeros([1,maxShift*2 + 1])
            ncf = 0
            ndaycf = 0
            for day in stack_day:
                ...
                for ii in range(len(data1_data2[0])):
                    if domain == 'freq':
#                        t_cf = cxcorr(data1_data2[0][ii,:],data1_data2[1][ii,:])                        
                       t_cf = signal.fftconvolve(data1_data2[0][ii,:], data1_data2[1][ii,:],mode='full')                                                
...
#                        t_cf = np.real(np.fft.ifft(f_cf))
                        ...
                        t_cf = correlate(data1_data2[0][ii,:], data1_data2[1][ii,:], maxShift, demean=True, normalize=True, domain=domain)
